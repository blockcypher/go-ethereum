...
import (
	...
	"github.com/blockcypher/go-ethereum/crypto/signify"
	"github.com/blockcypher/go-ethereum/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	...
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/blockcypher/go-ethereum/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/blockcypher/go-ethereum/internal/version.gitDate="+env.Date)
	}
...
func doCheckBadDeps() {
	baddeps := [][2]string{
		...
		{"github.com/blockcypher/go-ethereum/core/rawdb", "github.com/blockcypher/go-ethereum/ethdb/leveldb"},
		{"github.com/blockcypher/go-ethereum/core/rawdb", "github.com/blockcypher/go-ethereum/ethdb/pebbledb"},
	}
	tc := new(build.GoToolchain)
